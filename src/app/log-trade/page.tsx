    ...
    <UnifiedLayout>
      <div className="min-h-screen p-6 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-1">
          ...
          <div
            ref={spotlightRef}
            className="spotlight-wrapper relative rounded-2xl border border-[rgba(197,160,101,0.2)] bg-[rgba(18,18,18,0.4)] backdrop-blur-md overflow-hidden z-1"
          ...
          >
            ...
            {/* Form Content */}
            <form onSubmit={handleSubmit} className="relative z-1 p-8 space-y-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {strategyDropdownOpen && (
                        <div data-testid="strategy-dropdown-menu" className="absolute top-full left-0 right-0 z-50 w-full mt-2 max-h-60 overflow-y-auto rounded-lg shadow-2xl border border-[rgba(197,160,101,0.5)] bg-[#0A0A0A] custom-scrollbar" style={{ backgroundColor: '#0A0A0A', background: 'linear-gradient(135deg, #0A0A0A 0%, #121212 100%)' }}>
                          <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {sideDropdownOpen && (
                        <div data-testid="side-dropdown-menu" className="absolute top-full left-0 right-0 z-50 w-full mt-2 max-h-60 overflow-y-auto rounded-lg shadow-2xl border border-[rgba(197,160,101,0.5)] bg-[#0A0A0A] custom-scrollbar" style={{ backgroundColor: '#0A0A0A', background: 'linear-gradient(135deg, #0A0A0A 0%, #121212 100%)' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {emotionDropdownOpen && (
                        <div data-testid="emotion-dropdown-menu" className="absolute top-full left-0 right-0 z-50 w-full mt-2 max-h-60 overflow-y-auto rounded-lg shadow-2xl border border-[rgba(197,160,101,0.5)] bg-[#0A0A0A] custom-scrollbar" style={{ backgroundColor: '#0A0A0A', background: 'linear-gradient(135deg, #0A0A0A 0%, #121212 100%)' }}>
