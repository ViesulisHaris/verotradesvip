...
console.log('=====================================');
console.log('Generating 100 diverse trades with maximum data variety...');
...
function generateEmotionalStates() {
  ...
  // 30% chance of having additional emotions (1-2 more)
...
async function generateTrades(strategies) {
  ...
  console.log('📈 Generating winning trades...');
  ...
  console.log('📉 Generating losing trades...');
...
async function main() {
  try {
    ...
    if (insertedCount > 0) {
      ...
      console.log(`  - ~71% win rate maintained`);
      ...
      console.log(`  - Realistic P&L ranges ($50-$500 wins, -$25 to -$300 losses)`);
      console.log(`  - 60-day date range with weekday-only trading`);
      ...
      console.log('4. Verify charts and visualizations display correctly');
