...
(async () => {
  console.log('🔍 Starting Updated Sidebar Debug Test...');
  ...
  try {
    ...
    // Take screenshot
    await page.screenshot({ path: './debug-screenshots/sidebar-updated-debug.png' });
  ...
  console.log('🔍 Updated Sidebar Debug Test completed');
})();