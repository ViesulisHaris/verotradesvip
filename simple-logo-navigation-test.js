...
async function testLogoAndNavigation() {
  console.log('🧪 Starting Simple Logo and Navigation Testing...\n');
  ...
  try {
    // Navigate to the login page first (since it redirects there)
    ...
    // Test 3: Logout Button Styling (if visible on login page)
    ...
    if (logoutButton) {
      ...
      console.log('⚠️ Logout button not found on login page (expected)');
    }
